...
xterm  -e 'sshpass -p 44501516 ssh -f root@192.168.100.130 "./Tesis/Version3/FuzzyControl.bin > /dev/null 2>&1 & disown"' &
xterm  -e 'sshpass -p 44501516 ssh -f root@192.168.100.130 "./Tesis/Apps/usrSpace_buttons_EMIOgpio_PL_1 > /dev/null 2>&1 & disown"' &
